...
// Run with: PACKER_ACC=1 go test -count 1 -v ./provisioner/vergeio/provisioner_acc_test.go  -timeout=120m
func TestAccVergeIOProvisioner(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		Name: "vergeio_provisioner_basic_test",
		Setup: func() error {
			return nil
		},
		Teardown: func() error {
