...
// Run with: PACKER_ACC=1 go test -count 1 -v ./post-processor/vergeio/post-processor_acc_test.go  -timeout=120m
func TestAccVergeIOPostProcessor(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		Name: "vergeio_post-processor_basic_test",
		Setup: func() error {
			return nil
		},
		Teardown: func() error {
		...
		Type:     "vergeio-my-post-processor",
